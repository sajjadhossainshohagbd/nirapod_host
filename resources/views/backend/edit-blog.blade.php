	...
	<div class="row">
		<div class="col-md-11 mx-auto">
			<div class="card">
				...
				<div class="card-body">
					<form action="{{ route('update.blog',encrypt($blog->id)) }}" method="POST" enctype="multipart/form-data">
						@csrf
						...
						<div class="form-group row mb-2">
							...
							<div class="col-md-8">
								<textarea name="description" id="description" class="form-control" placeholder="Write a description...">{{ $blog->description }}</textarea>
							</div>
						</div>
						<div class="form-group row mb-2">
						...
						<div class="form-group row mb-2">
							...
							<div class="col-md-8">
								<input type="text" name="tags" class="form-control" data-role="tagsinput" value="{{ $blog->meta_keywords }}" required>
							</div>
						</div>
